...
| break up app.js into pieces. run it through a linter and compiler to minify. make source maps and host those too. tests will need to be split up as well, 1:1 component on the site, to test file. | ✅ Done |
